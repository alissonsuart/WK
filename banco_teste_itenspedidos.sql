...
CREATE TABLE `itenspedidos` (
  ...
  KEY `fkProdutosID_idx` (`idProduto`),
  KEY `fkPedidoID_idx` (`idPedido`),
  CONSTRAINT `fkPedidoID` FOREIGN KEY (`idPedido`) REFERENCES `pedidos` (`idPedido`),
  CONSTRAINT `fkProdutoID` FOREIGN KEY (`idProduto`) REFERENCES `produtos` (`idProduto`)
...
INSERT INTO `itenspedidos` VALUES (1,1,1,10.000,71.00);
