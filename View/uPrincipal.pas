...
begin
   ...
   begin
        lip := TItensPedido.Create;
        cdsItens.First;
        while not(cdsItens.Eof) do
        begin
           lip.IDItem           := cdsItensidItem.AsInteger;
           lip.IDPedido         := cdsItensidPedido.AsInteger;
           lip.IDProduto        := cdsItensidProduto.AsInteger;
           lip.DescricaoProduto := cdsItensDescricaoProduto.AsString;
           lip.Quantidade       := cdsItensquantidade.AsFloat;
           lip.ValorUnitario    := cdsItensvalor_unitario.AsFloat;

           cdsItens.Next;
        end;

        Controller.ItensPedido.InserirPedido(Lip);

//        for i := 0 to ListaItensPed.Count -1 do
//        begin
//           Controller.ItensPedido.InserirPedido(TItensPedido(ListaItensPed.ItensPedido(i)));
//        end;
...
begin
   ...
   Begin
      ...
      ValorTotal  := StrToFloat(Edit4.Text);
   End;
end;
